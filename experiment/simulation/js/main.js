...
function startSimulation(arrival_rate, service_rate, speed) {
    ...
    let valid = check(arrival_rate, service_rate,q_size,ns);
...
function startSimulation2(param1, param2, service_rate, speed) {
  ...
  let valid = check(param2-param1, service_rate,q_size,ns);
  if (!valid) return;
  let valid1 = check(param1,param2,q_size,ns);
  if (!valid1) return;
  clearChart();
  console.log(param1);
  console.log(param2);
...
function drawTable() {
    ...
    // document.getElementById("th_cs").innerHTML = ((th_cs>=0 && th_cs!=NaN)? th_cs.toFixed(2): "The value is not applicable for given inputs");
    // document.getElementById("ex_cs").innerHTML = ((ex_cs>=0 && ex_cs!=NaN)? ex_cs.toFixed(2): "The value is not applicable for given inputs");
    // document.getElementById("th_cq").innerHTML = ((th_cq>=0 && th_cq!=NaN)? th_cq.toFixed(2): "The value is not applicable for given inputs");
    // document.getElementById("ex_cq").innerHTML = ((ex_cq>=0 && ex_cq!=NaN)? ex_cq.toFixed(2): "The value is not applicable for given inputs");
    // document.getElementById("th_ts").innerHTML = ((th_ts>=0 && th_ts!=NaN)? th_ts.toFixed(2): "The value is not applicable for given inputs");
    // document.getElementById("ex_ts").innerHTML = ((ex_ts>=0 && ex_ts!=NaN)? ex_ts.toFixed(2): "The value is not applicable for given inputs");
    // document.getElementById("th_st").innerHTML = ((th_st>=0 && th_st!=NaN)? th_st.toFixed(2): "The value is not applicable for given inputs");
    // document.getElementById("ex_qt").innerHTML = ((ex_qt>=0 && ex_qt!=NaN)? ex_qt.toFixed(2): "The value is not applicable for given inputs");
    // document.getElementById("ex").innerHTML = "Experimental (" + ((time.toFixed(2)>=0)?time.toFixed(2):"Time for simulation cannot be generated for given inputs") + ")";
